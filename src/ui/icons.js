// Shared SVG icon strings — import here to keep icons identical across all components

export const CLEAR_ASPECTS_SVG = `<svg width="14" height="14" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
